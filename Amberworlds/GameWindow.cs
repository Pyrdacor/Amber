	...
	class GameWindow(string id = "MainWindow") : IContextProvider
{
    ...
    void Window_Load()
    {
        ...
        game = new Game.Game(new GameData.Default.GameData(), renderer/*, assetProvider, audioOuput, uiGraphicIndexProvider,
    ...
    public void Run()
    {
        try
        {
            ...
            gameVersion = $"Amberworlds v{version.Major}.{version.Minor}.{version.Build}";
            ...
            options.WindowClass = "Amberworlds";
