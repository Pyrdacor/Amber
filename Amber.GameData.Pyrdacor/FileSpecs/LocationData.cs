    ...
    internal class LocationData : IFileSpec
    {
        ...
        public void Write(IDataWriter dataWriter)
        {
            if (place == null || place.Data == null)
                throw new AmberException(ExceptionScope.Application, "Place data was null when trying to write it.");

            if (place.Data.Length != 32)
                throw new AmberException(ExceptionScope.Application, "Place data had wrong length when trying to write it.");
