...
public class FileReader : IFileReader
{
    ...
    private IFileContainer ProcessFileInfo(string name, FileInfo fileInfo, IDataReader reader)
    {
        ...
        else
        {
            ...
            else // sections
            {
                ...
                if (sectionCount == 0)
                    throw new AmberException(ExceptionScope.Data, "Invalid container section count.");
    ...
    private static IDataReader DecodeFile(IDataReader reader, FileType containerType, int fileNumber)
    {
        ...
        else
        {
            ...
            if (containerType == FileType.AMNP)
            {
                ...
                if (reader.ReadDword() != (uint)FileType.None)
                    throw new AmberException(ExceptionScope.Data, "Invalid AMNP file data.");
